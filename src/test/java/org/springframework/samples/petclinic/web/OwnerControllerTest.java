...
class OwnerControllerTest {
    ...
    void testFindOwnerOneResult() throws Exception {
        ...
        justOne.setId(7);
        final String foundJustOne = "FoundJustOne";
        justOne.setLastName(foundJustOne);
        given(clinicService.findOwnerByLastName(foundJustOne)).willReturn(Lists.newArrayList(justOne));
        mockMvc.perform(get("/owners")
                        .param("lastName", foundJustOne))
